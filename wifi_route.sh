...
MIDDLE_ADDR=pi@192.168.2.2
#STATION_ADDR=stereo@192.168.3.17
STATION_ADDR=stereo@stereo-UP-APL01

#STEREO_IP=10.0.0.1
#echo $LOCALS
CMD="ssh -t $LOCALS $REMOTES -L 2222:localhost:2222 $MIDDLE_ADDR ssh -N -L 2222:localhost:22 $LOCALS $REMOTES $STATION_ADDR"
echo $CMD
$CMD
